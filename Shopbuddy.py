...
st.set_page_config(page_title="Smart Shopper (Direct)", page_icon="🛍️", layout="wide")
...
st.title("🛍️ Smart Shopper: Agentic AI")
...
if st.button("🚀 Run Research & Analysis", type="primary"):
    if not product_name:
        ...
        try:
            ...
            status_container.write("🕵️ **Step 1: The Hunter is scouring the web...**")
            ...
            status_container.write("✍️ **Step 2: The Editor is compiling the guide...**")
            ...
            status_container.update(label="✅ Guide Generated!", state="complete", expanded=False)
